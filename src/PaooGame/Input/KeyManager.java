...
public class KeyManager implements KeyListener
{
    ...
    public boolean aup;//Flag pentru atac sus
    public boolean adown;//Flag pentru atac jos
    public boolean aleft;//Flag pentru atac stanga
    public boolean aright;//Flag pentru atac dreapta
