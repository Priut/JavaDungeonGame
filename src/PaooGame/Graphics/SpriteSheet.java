...
public class SpriteSheet
{
    ...
    private static final int    tileWidth[]   = {32,64,16, GameWindow.GetWndWidth()};   /*!< Latimea unei dale din sprite sheet.*/
    private static final int    tileHeight[]  = {32,64,16,GameWindow.GetWndHeight()};   /*!< Inaltime unei dale din sprite sheet.*/
     ...
     */
    public BufferedImage crop(int x, int y,int contor)
    {
        ...
        return spriteSheet.getSubimage(x * tileWidth[contor], y * tileHeight[contor], tileWidth[contor], tileHeight[contor]);
    }
}
